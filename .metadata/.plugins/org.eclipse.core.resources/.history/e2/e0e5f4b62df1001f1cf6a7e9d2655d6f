...
public class VocabularyContent {
	...
	public VocabularyContent(Long id, Vocabulary vocabulary, Long number, String content, String transcribe,
			String imageUrl, String audiomp3, String meaning, String sentence) {
		super();
		this.id = id;
