...
public class Part5ReadingExerciseAdminController {
	...
	public String list(Model model, @Param("keyword") String keyword,
		...
		try {
			...
			redirectAttributes.addFlashAttribute("errorMessage",
					"Có lỗi khi tải danh sách danh sách bài luyện đọc phần 5!");
		}
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
		try {
			...
			redirectAttributes.addFlashAttribute("successMessage", "Xóa bài luyện đọc phần 5 thành công!");
		} catch (Exception e) {
			logger.error("Lỗi khi xóa bài luyện đọc phần 5 với ID: " + id, e);
			redirectAttributes.addFlashAttribute("errorMessage", "Không thể xóa bài luyện đọc phần 5!");
		}
	...
	public String create(Model model, RedirectAttributes redirectAttributes) {
		try {
			...
			logger.error("Lỗi khi khởi tạo form thêm bài luyện đọc phần 5: ", e);
			redirectAttributes.addFlashAttribute("errorMessage",
					"Có lỗi xảy ra khi mở form thêm bài luyện đọc phần 5!");
			return "redirect:/admin/part5-reading-exercise";
		}
	...
	public String create(@ModelAttribute("readingExercise") ReadingExercise readingExercise,
		...
		try {
			...
			if (excelFile != null && !excelFile.isEmpty()) {
				...
				logger.warn("File Excel trống, bỏ qua quá trình xử lý nội dung bài luyện đọc phần 5.");
			}

			redirectAttributes.addFlashAttribute("successMessage", "Tạo danh sách bài luyện đọc phần 5 thành công!");
			return "redirect:/admin/part5-reading-exercise";

		} catch (Exception e) {
			logger.error("Lỗi khi tạo bài luyện đọc phần 5: ", e);
			redirectAttributes.addFlashAttribute("errorMessage", "Có lỗi xảy ra khi tạo bài luyện đọc phần 5!");
